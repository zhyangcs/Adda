                        ...
                        <div class="agents-container">
                          ...
                          >
                            <div class="agent-icon">
                              <img src="/dataset.png?v=2" alt="Dataset Info" class="agent-image" />
                            </div>
                          ...
                          >
                            <div class="agent-icon">
                              <img src="/robot2.png?v=2" alt="Main Agent" class="agent-image" />
                            </div>
                          ...
                          >
                            <div class="agent-icon">
                              <img src="/robot2.png?v=2" alt="Optimization Agent" class="agent-image" />
                            </div>
                          ...
                          >
                            <div class="agent-icon">
                              <img src="/val.png?v=2" alt="Validation" class="agent-image" />
                            </div>
