<template>
  <div class="feature-importance-panel" :class="{ 'snapshot-mode': isSnapshot }">
    <div class="panel-header" v-if="!isSnapshot">
      ...
      <div class="visualization-container">
        ...
        <div v-if="selectedMethod === 'paper'" class="paper-metrics-container">
          ...
          <div v-else class="paper-content modern-paper">
            <!-- 顶部摘要 -->
            <div class="top-summary" v-if="!isSnapshot">
...
.top-feature-list.modern .feature-name,
.top-feature-list.modern .feature-row {
  max-width: 100%;
  overflow: hidden;
  white-space: nowrap;
  text-overflow: ellipsis;
...
.feature-importance-panel.snapshot-mode {
  background: rgb(255, 255, 255) !important;
  border: none !important;
  box-shadow: none !important;
  padding: 0 !important;
...
.snapshot-mode .panel-content {
  overflow: visible !important;
  height: auto !important;
  flex: none !important;
}

.snapshot-mode .visualization-container,
.snapshot-mode .paper-metrics-container {
  padding: 0 !important;
  overflow: visible !important;
  height: auto !important;
  flex: none !important;
