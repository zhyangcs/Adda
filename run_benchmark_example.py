...
def run_quick_test():
    ...
    log_file = f"logs/quick_test_{timestamp}.log"
...
def run_medium_test():
    ...
    from datetime import datetime
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    log_file = f"logs/medium_test_{timestamp}.log"
...
def run_full_test():
    ...
    from datetime import datetime
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    log_file = f"logs/full_test_{timestamp}.log"
...
def run_custom_test():
    ...
    from datetime import datetime
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    log_file = f"logs/{output_prefix}_{timestamp}.log"
...
def run_table4_experiment():
    ...
    from datetime import datetime
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    log_file = f"logs/table4_experiment_{timestamp}.log"
    ...
    cmd = [
        ...
        "--single-timeout-minutes", "30",
        "--log-file", log_file,
        "--output-md", "table4_experiment_report.md",
        "--output-json", "table4_experiment_results.json"
    ]
    ...
    # 生成对比报告
    generate_comparison_report("table4_experiment_results.json", "table4")
...
def run_table5_experiment():
    ...
    from datetime import datetime
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    log_file = f"logs/table5_experiment_{timestamp}.log"
    ...
    cmd = [
        ...
        "--log-file", log_file,
        "--output-md", "table5_experiment_report.md",
        "--output-json", "table5_experiment_results.json"
    ]
    ...
    # 生成对比报告
    generate_comparison_report("table5_experiment_results.json", "table5")
